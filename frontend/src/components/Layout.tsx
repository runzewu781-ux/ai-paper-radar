    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 16px', fontFamily: 'system-ui, sans-serif' }}>
      <header style={{ display: 'flex', alignItems: 'center', gap: 24, padding: '16px 0', borderBottom: '1px solid #e5e7eb' }}>
        ...
        <nav style={{ display: 'flex', gap: 16, fontSize: 14 }}>
          <Link to="/papers" style={{ color: location.pathname === '/papers' ? '#2563eb' : '#666', textDecoration: 'none' }}>最新论文</Link>
          <Link to="/editorial" style={{ color: location.pathname === '/editorial' ? '#2563eb' : '#666', textDecoration: 'none' }}>编辑工作台</Link>
        </nav>
      </header>
